      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-16 text-center">
        <div className="w-full max-w-md space-y-10">
          ...
          <div className="flex justify-center">
            <div className="w-14 h-14 rounded-full bg-success-tint flex items-center justify-center text-success-deep">
          ...
          <div>
            ...
            <h1 className="font-display text-4xl md:text-5xl font-black uppercase tracking-tight text-primary leading-none">
              Order<br />Received
            </h1>
          </div>
          ...
          {isMobileMoney && (
            <div className="bg-primary text-left px-6 py-6 space-y-5">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-baseline border-b border-white/[0.08] pb-3">
                  <span className="text-[10px] tracking-widest uppercase text-white/60">Method</span>
                  <span className="text-sm font-bold uppercase tracking-tight text-white">
                    Selcom Lipa Namba
                  </span>
                </div>
                <div className="flex justify-between items-baseline border-b border-white/[0.08] pb-3">
                  <span className="text-[10px] tracking-widest uppercase text-white/60">Lipa Number</span>
                  <span className="text-xl font-black text-white tracking-tight">70019014</span>
                </div>
                <div className="flex justify-between items-baseline border-b border-white/[0.08] pb-3">
                  <span className="text-[10px] tracking-widest uppercase text-white/60">Name</span>
                  <span className="text-sm font-bold text-white tracking-wide text-right">
                    Edrick Neckemia<br />Katabarula
                  </span>
                </div>
                {total > 0 && (
                  <div className="flex justify-between items-baseline">
                    <span className="text-[10px] tracking-widest uppercase text-white/60">Amount</span>
                ...
                <ol className="space-y-2.5">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <span className="shrink-0 w-5 h-5 rounded-full bg-white/10 text-white/70 text-[10px] font-black flex items-center justify-center leading-none">
                        {i + 1}
                      </span>
                      <span className="text-xs text-white/80 tracking-wide leading-snug">{step}</span>
                    </li>
                  ))}
                </ol>
              </div>
              ...
              <a
                ...
                className="mt-2 flex items-center justify-center gap-3 w-full bg-white text-primary text-xs font-black tracking-ultra uppercase py-4 hover:bg-smoke transition-colors duration-200"
              >
